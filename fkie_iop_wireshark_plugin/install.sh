...
command -v pyxbgen >/dev/null 2>&1 || { echo >&2 "pyxbgen required but it's not installed. install PyXB first: pip install PyXB-X.  Aborting."; exit 1; }
...
python3 scripts/iop_create_dissector.py --input_path $JSIDL_DIR --output_path $WIRESHARK_PLUGIN_DIR/fkie_iop.lua --exclude urn.jaus.jss.core-v1.0
