...
macro(generate_jsidl_pyxb)
    ...
    if (NOT ${CATKIN_DEVEL_PREFIX})
        ...
        if ( EXISTS ${CATKIN_DEVEL_PREFIX}/lib/python3)
            ...
            set(PYXB_GENERATED_SRC_DIR "${CATKIN_DEVEL_PREFIX}/lib/python${Python_VERSION_MAJOR}.${Python_VERSION_MINOR}/site-packages/jsidl_pyxb")
        endif()
    elseif (NOT ${CMAKE_INSTALL_PREFIX})
        ...
        if ( EXISTS ${CMAKE_INSTALL_PREFIX}/lib/python3)
            ...
            set(PYXB_GENERATED_SRC_DIR "${CMAKE_INSTALL_PREFIX}/lib/python${Python_VERSION_MAJOR}.${Python_VERSION_MINOR}/site-packages/jsidl_pyxb")
        endif()
    else ()
